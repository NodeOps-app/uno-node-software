...
You can find the full ABI used by the NFT contract below:
```.json
"abi": [
    {
      "inputs": [],
    ...
    {
      "inputs": [],
      "name": "BuybackNotActive",
      "type": "error"
    },
    {
      "inputs": [],
      "name": "BuybackNotConfigured",
      "type": "error"
    },
    {
      "inputs": [
    ...
    },
    {
      ...
      "name": "batchMintWithCanonicalIds",
      "outputs": [],
      "stateMutability": "nonpayable",
      "type": "function"
    },
    {
      "inputs": [
        ...
        {
          "internalType": "uint256[]",
          "name": "newCanonicalIds",
          "type": "uint256[]"
        }
      ],
      "name": "batchUpdateCanonicalIds",
      "outputs": [],
      "stateMutability": "nonpayable",
      "type": "function"
    },
...
"abi": [
    ...
    },
    {
      ...
      "name": "getDelegatedLicensesForOwner",
      "outputs": [
        {
          "internalType": "uint256[]",
          "name": "",
      ...
      "outputs": [
        {
          ...
          "internalType": "struct OrchestratorTypes.OperatorInfo",
          "name": "",
          "type": "tuple"
        }
      ],
    ...
    },
    {
      ...
      "name": "permissionedDelegateLicenses",
      "outputs": [],
      "stateMutability": "nonpayable",
      "type": "function"
    },
